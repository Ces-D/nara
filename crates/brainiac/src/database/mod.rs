...
pub use operations::{
    ...
    get_practice_item_answer, get_practice_item_with_answer, get_practice_items,
    list_categories_with_tags, list_tags, rate_practice_item, remove_tag_from_category,
    update_item,
};
